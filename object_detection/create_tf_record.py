...
r"""Convert raw PASCAL like dataset to TFRecords for object_detection.
"""
...
flags.DEFINE_string('output_dir', '', 'Dir to output TFRecords')
flags.DEFINE_string('label_map_path', 'label_map.pbtxt',
                    'Relative path to label map protobuf')
FLAGS = flags.FLAGS
...
def create_tf_record(output_filename,
    ...
    for idx, example in enumerate(examples):
        ...
        tf_example = dict_to_tf_example(data, label_map_dict, image_path)
...
def main(_):
    ...
    label_map_dict = label_map_util.get_label_map_dict(os.path.join(
        data_dir, FLAGS.label_map_path))
